...
import { getHeroImages } from '../services/mediaService';
import './ImageSlider.css';

const staticSlides = [
  { image: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=1400&q=85', alt: 'Truck loaded with Rodi material ready for delivery', label: 'Fast Delivery' },
  { image: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=1400&q=85', alt: 'Large pile of Rodi stone aggregate at yard', label: 'Premium Rodi' },
  { image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1400&q=85', alt: 'Quality Bajri fine aggregate supply', label: 'Quality Bajri' },
  { image: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=1400&q=85', alt: 'Truck unloading material at construction site', label: 'Site Delivery' },
  { image: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1400&q=85', alt: 'Construction material supply Rajasthan', label: 'Bulk Supply' },
];

interface Slide { image: string; alt: string; label: string; }
...
export default function ImageSlider() {
  ...
  useEffect(() => {
    getHeroImages().then(data => {
      if (data.length > 0) {
        setSlides(data.map(m => ({ image: m.public_url, alt: m.title, label: m.title })));
        setCurrent(0);
      }
